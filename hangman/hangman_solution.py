...
class Hangman:
    ...
    def check_letter(self):
        ...
        # refresh the current status of unique letters and remaining lives         
        self.num_letters = self.num_letters             
        self.num_lives = self.num_lives   
        ...
        while True:
            ...
            if len(self.letter) == 1: # accept only one character
                ...
                if self.letter not in string.ascii_letters: # check if the letter given by the user is valid (and not a number i.e)            
                    ...
                    self.list_letters = self.list_letters # refresh status of list list_letters                                             
